...
def test_package_imports_cleanly() -> None:
    ...
    import robot_data_recorder  # noqa: F401


def test_version_string() -> None:
    from robot_data_recorder import __version__
...
def test_realsense_flag_accessible() -> None:
    ...
    from robot_data_recorder.d435 import _HAS_REALSENSE
...
def test_lerobot_flag_accessible() -> None:
    ...
    from robot_data_recorder.so101_teleop import _HAS_LEROBOT

    assert isinstance(_HAS_LEROBOT, bool)


def test_dual_writer_lerobot_flag_accessible() -> None:
    from robot_data_recorder.dual_writer import _HAS_LEROBOT

    assert isinstance(_HAS_LEROBOT, bool)


def test_stable_worldmodel_flag_accessible() -> None:
    from robot_data_recorder.dual_writer import _HAS_STABLE_WORLDMODEL

    assert isinstance(_HAS_STABLE_WORLDMODEL, bool)


def test_schema_module_imports_cleanly() -> None:
    from robot_data_recorder import schema  # noqa: F401


def test_config_module_imports_cleanly() -> None:
    from robot_data_recorder import config  # noqa: F401


def test_recorder_module_imports_cleanly() -> None:
    from robot_data_recorder import recorder  # noqa: F401


def test_cli_module_imports_cleanly() -> None:
    from robot_data_recorder import cli  # noqa: F401
